...
SSP21 uses the same key derivation function defined in Noise. It is invoked, however, with slightly different
parameters as described in [the section on key negotiation][Key Negotiation Handshake].
